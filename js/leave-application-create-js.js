$(document).ready(function(){
    ...
    $("[name='submit-leave-application-form']").click(function(e){
    ...
    $("#submit_verify_pdf").click(function(){
      ...
      {
        // genDocFile = new File([genDocFile], "gen_doc_file.pdf");
        // form.append('genDocFile', genDocFile);

        $.ajax({
                    url: 'ajax-leave-application-insert.php',
                    method: 'POST',
                    contentType: false,
                    processData: false,
                    data: form,
