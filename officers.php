...
if (isset($_SESSION["id"]) && isset($_SESSION["user_type"])) 
{
  ...
  {
    $selectEmpDetails = mysqli_query($conn,"SELECT * FROM employees WHERE `emp_category` = 'Officer'");
  }
?>
    ...
    <div class="main-panel">
      ...
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">    
            <h4 class="card-title text-center">Officers Details</h4>  
          ...
          ?>
            ...
            <?php } ?> <?php echo $row['first_name']." ".$row['last_name'] ?></td>
             ...
             <?php
              ...
              ?>
              <td>
              <a type="submit" class="badge badge-success" href="edit-employee.php?id=<?php echo $row['id'] ?>&emp_category=<?php echo $row['emp_category'] ?>" title="Edit Officer">
                ...
                <a type="submit" class="badge badge-danger" onclick="return confirm(' Are You Sure Want To Delete ?');" href="delete-employee.php?id=<?php echo $row['id'] ?>&emp_category=<?php echo $row['emp_category'] ?>" title="Delete Officer">
