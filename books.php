...
{
    $selectBooks = mysqli_query($conn, "SELECT * FROM `books`");
    ?>
        ...
        <div class="card">
          <div class="card-body">    
            ...
            <table class="table table-bordered table-hover display nowrap data-table">
              ...
              <?php 
          $i=1;
          while($book = mysqli_fetch_array($selectBooks)) 
          { 
          ?>
            <tr>
                <td><?php echo $i; ?></td>
              <td><?php echo "<a href='book-details.php?id=$book[id]'>".$book['book_name']."</a>"; ?></td>
              ...
              ?>
              <td>
                  <a type="submit" class="badge badge-success" title="Edit" href="edit-book.php?id=<?php echo $book['id'] ?>">
                  ...
                  <a type="submit" class="badge badge-danger" title="Delete" onclick="return confirm(' Are You Sure Want To Delete ?');" href="delete-book.php?id=<?php echo $book['id'] ?>" >
