...
<div class="main-panel">
  ...
  <div class="card">
      <div class="card-body">
        <h4 class="text-center">Add Inward</h4>
        ...
        <form class="form-sample" method="post" autocomplete="off" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 ">
                            ...
                            <button type="submit" class="btn btn-gradient-primary btn-rounded btn-fw mb-2 float-right mr-5" name="submit-add-inward-form">Submit</button>
                        </div>
                      </div>           
          </form>
      </div>
...
<?php
if(isset($_POST['submit-add-inward-form']))
{
  ...
  $insertQuery = "INSERT INTO inwards(id, subject, inward_date, communication_type, classification, year,department, remarks, name_of_receiver, address_of_receiver, state, upload_name, upload, created_by) VALUES(UUID(),'" . $_POST['subject'] . "','" . $_POST['inward_date'] . "','" . $_POST['communication_type'] . "', '" . $_POST['classification'] . "', '" . date('Y', strtotime($_POST['inward_date'])) . "','" . $_POST['department'] . "', '" . $_POST['remarks'] . "','" . $_POST['name_of_receiver'] . "','" . $_POST['address_of_receiver'] . "','" . $_POST['state'] . "','" . $fileName . "','" . $docData . "', '" . $_SESSION["id"] . "')";

  $addInward = mysqli_query($conn, $insertQuery);

  if($addInward == 1)
  {
      $_SESSION["message"] = "Inward Entry Added Successfully";
