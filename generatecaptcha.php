...
if (PHP_OS == "Linux") {
  $font = "/var/www/html/MaterialDesign-Webfont-master/fonts/monofont.ttf";
} else {
  $font = realpath("MaterialDesign-Webfont-master/fonts/monofont.ttf");
}
...
$x = round(($image_width - $textbox[4]) / 2);
$y = round(($image_height - $textbox[5]) / 2);
